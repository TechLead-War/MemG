/**
 * SQLite DDL for the MemG schema. Matches the Go sqlstore.sqliteQueries() exactly.
 */
export const SCHEMA_DDL: string[] = [
  ...
  // v2 migration: add emotional, verbatim, temporal, thread, engagement, pinned columns
  `ALTER TABLE mg_entity_fact ADD COLUMN emotional_weight REAL`,
  `ALTER TABLE mg_entity_fact ADD COLUMN emotional_valence TEXT`,
  `ALTER TABLE mg_entity_fact ADD COLUMN verbatim TEXT`,
  `ALTER TABLE mg_entity_fact ADD COLUMN started_at TEXT`,
  `ALTER TABLE mg_entity_fact ADD COLUMN thread_status TEXT`,
  `ALTER TABLE mg_entity_fact ADD COLUMN engagement_score REAL NOT NULL DEFAULT 0`,
  `ALTER TABLE mg_entity_fact ADD COLUMN pinned INTEGER NOT NULL DEFAULT 0`,
