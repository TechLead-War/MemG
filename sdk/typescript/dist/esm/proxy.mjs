 ...
 */
export function wrapOpenAIProxy(client, entity, proxyUrl = 'http://localhost:8787/v1') {
    const headers = {};
    if (entity)
 ...
 */
export function wrapAnthropicProxy(client, entity, proxyUrl = 'http://localhost:8787/v1') {
    const headers = {};
    if (entity)
        headers['X-MemG-Entity'] = entity;
    return client.withOptions({ baseURL: proxyUrl, defaultHeaders: headers });
